...
import {
  ...
  HardDrive, Building2, Cpu, Terminal, BookOpen, Brain, Map, Wrench, Eye, Database, ShieldCheck, GitMerge, AlertTriangle
} from 'lucide-react'
...
const navItems = [
  ...
  { to: '/backup', icon: HardDrive, label: 'Backup DB' },
  { to: '/device-backup', icon: Database, label: 'Backup Dispositivos' },
